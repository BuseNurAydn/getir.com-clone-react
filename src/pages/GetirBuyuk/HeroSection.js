        ...
        <>
            ...
            <div className="relative h-[500px] before:bg-gradient-to-r before:from-brand-color before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10 ">
              {width >= 768 && <Slider {...settings}>
                ...
                <div className="md:container relative md:absolute p-12 top-0 left-1/2 -translate-x-1/2 md:-translate-x-1/2 h-full z-10 flex items-center justify-between ">
                    ...
                    <div className="w-full md:w-[400px] rounded-lg bg-gray-50 p-6">
                        ...
                        <div class="grid gap-y-3">
                            ...
                            <button className="bg-yellow-color text-brand-color transition-colors hover:bg-brand-color hover:text-yellow-color h-12 flex items-center justify-center rounded-md w-full text-sm font-semibold sm:w-full">
