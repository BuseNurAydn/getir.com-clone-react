...
const HeroSection = () => {
    ...
    return (
        <>
            <div className="relative h-[500px] before:bg-gradient-to-r before:from-brand-color before:to-transparent before:absolute before:inset-0 before:w-full before:h-full ">
                <Slider {...settings}>
                    <div>
                ...
                <div className="container absolute top-0 pl-8 left-1/2 -translate-x-1/2 h-full z-20 flex items-center justify-between">
                    <div>
                        <img
                            ...
                            alt="Logo"
                        />
                        <h3 className="text-4xl mt-8 font-semibold text-white w-full ">Binlerce ürün ve kaçmaz <br /> fiyatlar kapında!</h3>
                    </div>
                    <div className="w-full md:w-[400px] md:rounded-lg bg-gray-50 p-6">
                        <h4 className="text-brand-color text-center font-semibold mb-4">Giriş yap veya kayıt ol</h4>
                        <div class="grid gap-y-3">
                            <div className="flex gap-x-2">
                                ...
                                <label className="flex-1 relative group block cursor-pointer">
                                    <input required className="h-14 px-4 border-2 border-gray-200 rounded w-full transition-colors group-hover:border-brand-color focus:border-brand-color outline-none peer text-sm pt-2" />
                            ...
                            <button className="bg-yellow-color text-brand-color transition-colors hover:bg-brand-color hover:text-yellow-color h-12 flex items-center justify-center rounded-md w-full text-sm font-semibold ">
