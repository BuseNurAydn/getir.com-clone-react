...
const MobileApp = () => {
  return (
    <div className='md:container md:mx-auto px-0 md:px-2 lg:px-4 xl:px-16'>
      <div className=' flex flex-col md:flex-row justify-between md:items-center px-5 bg-brand-color md:bg-mobile mt-0 md:mt-6 md:rounded-lg text-white'>
