    ...
    <div className='container mx-auto px-16 mb-20 '>
      <div className=' flex justify-between items-center bg-business rounded-lg '>
        <div className='flex flex-col gap-y-3 py-16 px-8'>
          ...
          <span className='font-semibold text-base text-graytwo-color'>GetirÇarşı işletme iş ortaklarından biri ol, işini daha az maliyetle büyüt, müşteri memnuniyetini artır.</span>
        </div>
